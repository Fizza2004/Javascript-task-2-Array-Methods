...
//*****-------------TASK1------------*****
//Write all the elements in the console that has ID 11075
//-------------------------------
//*----First option----*

// function getOrderById(arr,callback){
//   let newArray=[];
//   for (i=0;i<arr.length;i++){
//     let newElement = callback(arr[i].id);
//     if(newElement){
//       newArray.push(arr[i]);
//     }
//   }
...
// console.log(getOrderById(orderList,id=>id==11075));
//-------------------------------

//*----Second option----*
// console.log(orderList.filter(item=>item.id==11075));
//-------------------------------


//*****-------------TASK2------------*****
//In the console, show the num of all elements that their shipAdress is country USA
//*----First option----*
// let num=0;
...
//   }
// });
// console.log('Num of elements with shippingAdress USA is',num);
//------------------------------